...
$hob = $db->query("SELECT * FROM hobbies WHERE id_user = ?", [$_SESSION['auth']->id])->fetchAll();
  ...
  <div id="profil-background">
    ...
    <div class="flex">
      <form action="" method="post" enctype="multipart/form-data">
        ...
        <textarea class="field-global profil-field" name="description" rows="15" cols="180"><?= $description->description; ?></textarea>
        <br/><br/>
        <h1>Autre</h1>
        ...
        <table cellspacing="20">
          <tr>
            ...
            <td><input class="field-global profil-field" name="poste" value="<?= $description->poste; ?>"></td>
          </tr>
          <br/><br/>
          <tr>
            <td><label for="hobbies">Vos centres d'interets</label></td>
            <td><input class="field-global profil-field" type="text" name="hobbies[]" rows="1" cols="50"></td>
            <td><input class="field-global profil-field" type="text" name="hobbies[]" rows="1" cols="50" ></td>
          </tr>
        </table>

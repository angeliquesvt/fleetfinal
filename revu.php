...
<header class="head">
  ...
  <?php endif; ?>
    ...
    <section class="projet-description">
      <div class="bandeau-projet" style="background-image: url('<?php $image->getImage($revu->background, 'revu'); ?>')">
	  ...
	  <br>
		...
		<div class="h--posts" >
		<?php $articles = $db->query('SELECT * FROM revu LIMIT 4')->fetchAll(); ?>
    ...
    <?php foreach ($articles as $article): ?>
      <div class="h--posts-item revu_lifestyle revu">
					...
					<div class="h--post-item-img">
							<img src="<?php $image->getImage($article->background, "revu"); ?>" alt="project_image">
					</div>
